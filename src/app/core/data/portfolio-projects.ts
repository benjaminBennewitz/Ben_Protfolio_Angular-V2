  ...
  de: [
      {
        ...
        appModules: [
          { id: 'document-share', title: 'Document Share', text: 'Zentrale Dokumentablage mit Kategorien, Versionen, Vorschauen, Suchindex und berechtigungsabhängigen Zugriffen.', icon: 'menu_book', badge: 'Live', status: 'live' },
          { id: 'production', title: 'Produktionsplanung', text: 'Planung, AU-Import, Versand, Archiv, Teilmengen, Statuslogik und Konfliktauflösung.', icon: 'factory', badge: 'Core', status: 'live' },
          { id: 'projects', title: 'Projects', text: 'Internes Aufgaben- und Projektmanagement mit Boards, Pool, Kommentaren, Anhängen und Produktions-Sync.', icon: 'hub', badge: 'Sync', status: 'live' },
          { id: 'health', title: 'System Health', text: 'Monitoring für PostgreSQL, Redis, Channels, Celery, Systemd-Services und Logs.', icon: 'database', badge: 'Ops', status: 'private' },
          ...
          { id: 'complaints', title: 'Reklamationen', text: 'Kundenreklamationen mit Medienupload, Statusverlauf, Kommentaren und Nachverfolgung.', icon: 'crisis_alert', badge: 'Live', status: 'live' },
          { id: 'analysis', title: 'Produktanalyse', text: 'Auswertungen, Vergleiche und Reports für Produktion, Qualität und interne Entscheidungen.', icon: 'monitoring', badge: 'Lab', status: 'private' },
        ],
        terminalWidgets: [
        ...
        architecture: [
          { id: 'frontends', label: 'Angular Frontends', icon: 'deployed_code', role: 'Presentation Layer', text: 'Mehrere eigenständige Angular-Oberflächen bleiben fachlich getrennt. Shared Auth, shared-nav und shared-toast sind zentral aufgebaut und in jedem Frontend eingebunden; Guards, Interceptors und Designsystem folgen denselben globalen Konventionen.', connections: ['shared-nav · global', 'shared-toast · global', 'Django REST API', 'Django Channels'] },
  ...
  en: [
      {
        ...
        appModules: [
          { id: 'document-share', title: 'Document Share', text: 'Central document storage with categories, versions, previews, search index and permission-aware access.', icon: 'menu_book', badge: 'Live', status: 'live' },
          { id: 'production', title: 'Production planning', text: 'Planning, AU imports, shipping, archive, partial quantities, state logic and conflict resolution.', icon: 'factory', badge: 'Core', status: 'live' },
          { id: 'projects', title: 'Projects', text: 'Internal task and project management with boards, pool logic, comments, attachments and production sync.', icon: 'hub', badge: 'Sync', status: 'live' },
          { id: 'health', title: 'System Health', text: 'Monitoring for PostgreSQL, Redis, Channels, Celery, systemd services and logs.', icon: 'database', badge: 'Ops', status: 'private' },
          ...
          { id: 'complaints', title: 'Complaints', text: 'Customer complaints with media upload, status history, comments and traceability.', icon: 'crisis_alert', badge: 'Live', status: 'live' },
          { id: 'analysis', title: 'Product analytics', text: 'Reports, comparisons and KPIs for production, quality and internal decisions.', icon: 'monitoring', badge: 'Lab', status: 'private' },
        ],
        terminalWidgets: [
          { id: 'status', title: 'system-status.bat', position: 'status', lines: ['SYSTEM STATUS', 'API latency: 38ms', 'DB connections: 32', 'Celery queue: healthy', 'Status: OK'] },
        ...
        architecture: [
          { id: 'frontends', label: 'Angular Frontends', icon: 'deployed_code', role: 'Presentation Layer', text: 'Multiple standalone Angular interfaces stay separated by domain. Shared auth, shared-nav and shared-toast are central components included in every frontend; guards, interceptors and the design system follow the same global conventions.', connections: ['shared-nav · global', 'shared-toast · global', 'Django REST API', 'Django Channels'] },
