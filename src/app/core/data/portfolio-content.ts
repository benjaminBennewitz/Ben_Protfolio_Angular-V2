...
export const PORTFOLIO_TRANSLATIONS: Record<'de' | 'en', PortfolioContent> = {
  de: {
    ...
    pricing: {
      ...
      subtitle: 'Websites, Anwendungen und digitale Systeme für Projekte, die Aufmerksamkeit brauchen, Prozesse vereinfachen oder aus einer Idee ein funktionierendes Produkt machen sollen.',
      offersEyebrow: 'solutions.loaded',
      offersTitle: 'Drei Einstiege. Ein Prinzip: passend zum Ziel.',
      offersSubtitle: 'Vom fokussierten Einstieg bis zur individuellen Anwendung wächst der Umfang mit dem Problem – nicht mit einer Paketliste.',
      ...
      cards: [
        {
          ...
          price: 'ab 500 €',
          claim: 'Schnell sichtbar. Klar fokussiert.',
          ...
          features: ['Kompakter Onepager oder fokussierte Landingpage', 'Eigenständiges Responsive Design statt Standardvorlage', 'Schneller, sauberer technischer Aufbau'],
        ...
        },
        {
          ...
          features: ['Durchdachte Struktur für Leistungen, Inhalte und Kontakt', 'Visuelles System passend zu Marke und Zielgruppe', 'Nutzerführung mit Fokus auf Engagement und Conversion'],
  ...
  en: {
    ...
    pricing: {
      ...
      subtitle: 'Websites, applications and digital systems for projects that need attention, simpler workflows or a working product built from an idea.',
      offersEyebrow: 'solutions.loaded',
      offersTitle: 'Three starting points. One principle: fit the goal.',
      offersSubtitle: 'From a focused entry point to a custom application, scope grows with the problem – not with a package list.',
      ...
      cards: [
        {
          title: 'Starter Website',
          price: 'from €500',
          claim: 'Visible fast. Focused clearly.',
          ...
          command: 'web --landing --responsive --fast',
          features: ['Compact onepager or focused landing page', 'Distinct responsive design instead of a standard template', 'Fast, clean technical foundation'],
        ...
        },
        {
          ...
          command: 'web --brand --content --conversion',
          features: ['Thoughtful structure for services, content and contact', 'Visual system aligned with brand and audience', 'User journeys focused on engagement and conversion'],
