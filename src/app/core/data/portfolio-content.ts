  ...
  de: {
    ...
    projects: [
      ...
      },
      {
        ...
        titleLines: ['Daten', 'Dashboards'],
        kicker: 'PDF-Analyse, Laborwerte und visuelle Datenaufbereitung.',
        summary: 'Ein Dashboard-Konzept, das Laborbefunde in verständliche Datenschnitte übersetzt: Werte einlesen, prüfen, optional manuell ergänzen und sofort sichtbar machen, ob Ergebnisse im grünen Bereich liegen.',
        overviewKicker: 'Grafische Aufbereitung von Daten.',
        overviewSummary: 'Ein datenorientiertes Dashboard, das PDF-Befunde, API-Importe und manuelle Eingaben in klare Karten, Referenzbereiche und Diagramme übersetzt. Der Fokus liegt auf Orientierung, Kontrolle und verständlichen Erklärungen statt auf Zahlenkolonnen.',
        overviewTechStack: ['Angular', 'TypeScript', 'PDF-Analyse', 'API-Konzept', 'SCSS'],
        description: 'Das Projekt denkt Laborwerte als kontrollierbaren Datenworkflow: Befunde können per PDF-Analyse, API-Import oder händischer Eingabe in strukturierte Datensätze überführt werden. Das Dashboard gruppiert Werte, zeigt Referenzbereiche, markiert Auffälligkeiten, erklärt einzelne Kennzahlen und bezieht optionale Kontextfaktoren wie Alter, Lebensstil oder Messdatum ein, ohne daraus eine Diagnose abzuleiten.',
        goal: 'Ziel ist ein Dashboard, das Nutzerinnen und Nutzern mehr Kontrolle über schwer lesbare Befunde gibt. Relevante Werte sollen einfach erfassbar, grafisch vergleichbar und direkt verständlich sein: mit grünen Bereichen, Warnzuständen, Trends, Detailkarten, Quellenhinweisen und klarer Trennung zwischen technischer Aufbereitung, Erklärung und medizinischer Bewertung.',
        role: 'Konzept für Datenmodell, PDF-/API-Import, optionalen manuellen Übertrag, Validierungslogik, Dashboard-Architektur, Diagrammvarianten, Referenzbereich-UI, Kontextfaktoren, Hilfetexte, Fehlerzustände und datenschutzfreundliche Demo-Grenzen.',
        year: '2025',
        type: 'Health Data UI / Document Import',
        accent: 'blue',
        techStack: ['Angular', 'TypeScript', 'Python/API', 'PDF-Analyse', 'Serverless-Idee', 'SCSS'],
        highlights: ['PDF-/API-Import', 'Manuelle Eingabe', 'Referenzbereich-Skalen', 'Dashboard-Karten', 'Validierung', 'Trend-Ansicht', 'Kontextfaktoren', 'Barrierearme Daten-UI'],
        technicalHighlights: [
          { icon: 'upload_file', title: 'Werte einlesen', text: 'Befunde können per PDF-Analyse, API-Import oder Datei-Input in einen prüfbaren Aufbereitungsflow überführt werden.' },
          { icon: 'edit_note', title: 'Manuell ergänzen', text: 'Unsichere oder fehlende Werte bleiben editierbar, damit Nutzer die Kontrolle über die Datenübernahme behalten.' },
          ...
          { icon: 'monitoring', title: 'Sofortige Einordnung', text: 'Skalen, Balken, Charts und Statuskarten zeigen schneller als Tabellen, ob Werte im grünen Bereich liegen.' },
          { icon: 'psychology_alt', title: 'Erklärungen bei Bedarf', text: 'Zu jedem Wert können verständliche Hinweise, Kontextfragen und nächste sinnvolle Prüfpunkte geöffnet werden.' },
          ...
          { icon: 'person_search', title: 'Kontextfaktoren', text: 'Alter, Lebensstil, Messdatum oder Verlauf können als optionale Faktoren sichtbar mitgedacht werden.' },
        ...
        requirements: ['PDF-Befunde analysieren oder per API einlesen', 'Manuelle Eingabe als Fallback anbieten', 'Laborwerte zuverlässig strukturieren', 'Einheiten und Referenzbereiche prüfen', 'Grüne Bereiche und Warnzustände sofort sichtbar machen', 'Kontextfaktoren optional berücksichtigen', 'Hilfetexte pro Wert anbieten', 'Sensible Daten in Demos vermeiden'],
        detailMode: 'data',
        metrics: [
          { value: 'PDF/API', label: 'Import', text: 'Befunde starten als Dokument, API-Daten oder manuelle Eingabe und werden zu strukturierten Datensätzen.' },
          { value: '40+', label: 'Wertefelder', text: 'Laborwerte brauchen Namen, Einheit, Referenzbereich, Status und Erklärung.' },
          { value: '3×', label: 'Kontrolle', text: 'Erkennung, Plausibilität und manuelle Kontrolle verhindern blinde Übernahmen.' },
        ...
        bloodShowcase: {
          ...
          lead: 'Der Kern ist kein einzelnes Diagramm, sondern ein nachvollziehbarer Ablauf: PDF oder API-Daten einlesen, Werte prüfen, Kontext ergänzen, Referenzbereiche abbilden und daraus ein verständliches Dashboard erzeugen.',
          ctaLabel: 'Dashboard-Flow ansehen',
          chips: ['PDF/API Import', 'Value Parser', 'Reference Ranges', 'Help Cards'],
          documentTitle: 'laborbefund_2025.pdf',
          documentText: 'Dokument erkannt · Werte werden extrahiert · unsichere Felder bleiben editierbar.',
          ...
          previewLabel: 'Vorschau eines Daten-Dashboards mit PDF-Import, Kontextwerten und Ergebnisgrafiken',
          values: [
          ...
          pipelineSteps: [
            { icon: 'upload_file', title: 'Import', text: 'Der Nutzer startet mit PDF, API-Quelle oder manueller Eingabe. Wichtig ist ein sauberer Einstieg mit Status, Dateityp, Datenschutzgrenze und Fehlermeldungen.', points: ['PDF/API Input', 'Aufbereitungsstatus', 'Fehlerzustände'] },
            { icon: 'document_scanner', title: 'Lesen & Erfassen', text: 'Werte werden erkannt, normalisiert und in bearbeitbare Felder übertragen. Unsichere Treffer müssen sichtbar und korrigierbar bleiben.', points: ['Wertname', 'Einheit', 'Referenzbereich'] },
            { icon: 'rule_settings', title: 'Prüfen', text: 'Die Daten werden gegen erwartete Formate, Einheiten, Referenzbereiche und optionale Kontextfaktoren geprüft, bevor sie in die Auswertung gehen.', points: ['Validierung', 'Plausibilität', 'Kontext'] },
            { icon: 'analytics', title: 'Visualisieren', text: 'Das UI übersetzt Zahlen in Skalen, Balken, Charts, Gruppen und Detailkarten, damit Zusammenhänge schneller erfassbar werden.', points: ['Skalen', 'Balken', 'Trend-Idee'] },
          ...
          guideModeLabel: 'Darstellungsart des Werte-Guides wählen',
          guideModes: [
          ...
          disclaimer: 'Die Oberfläche soll Daten verständlich erklären und Hinweise geben. Sie ersetzt keine ärztliche Diagnose und sollte mit synthetischen Demo-Daten gezeigt werden.',
          galleryEyebrow: 'Dashboard Evidence',
          galleryTitle: 'Screens für Import, Werte, Erklärungen und Diagrammvarianten',
        },
        chapters: [
          { eyebrow: 'Import', title: 'Aus Befunden werden kontrollierbare Daten', text: 'Der technische Schwerpunkt liegt auf dem Übergang von PDF, API oder manueller Eingabe zu einem prüfbaren Datensatz. Import, Erkennung, Korrektur und Validierung müssen als ein zusammenhängender Workflow funktionieren.', points: ['PDF/API und Status', 'Erkannte Werte editierbar halten', 'Unsicherheiten markieren'] },
          { eyebrow: 'Datenmodell', title: 'Ein Blutwert ist mehr als Name und Zahl', text: 'Jeder Wert braucht Einheit, Referenzbereich, Quelle, Messdatum, Status, Erklärung und optionale Faktoren wie Alter, Lebensstil oder Verlauf. Nur so kann das UI nachvollziehbar erklären, warum etwas auffällt.', points: ['Einheit und Referenzbereich', 'Quelle und Messdatum', 'Kontext und Hilfetext'] },
          { eyebrow: 'Visualisierung', title: 'Zahlen werden als Orientierung lesbar', text: 'Die Darstellung soll nicht dramatisieren. Skalen, Balken, Charts, Gruppen und neutrale Status machen sichtbar, ob ein Wert im Beispiel niedrig, normal, erhöht oder beobachtenswert ist.', points: ['Referenzbereich-Skalen', 'Kompakte Karten', 'Diagrammvarianten'] },
        ...
        gallery: [
          { title: 'Import Flow', text: 'PDF, API-Daten oder manuelle Eingabe übernehmen und unsichere Felder sichtbar prüfen.', size: 'md', icon: 'upload_file', annotations: ['PDF', 'API', 'Review'] },
          { title: 'Daten-Dashboard', text: 'Laborwerte gruppieren, Referenzbereiche anzeigen und Auffälligkeiten sofort sichtbar machen.', size: 'lg', icon: 'monitoring', annotations: ['Hb', 'CRP', 'Ferritin'] },
          ...
          { title: 'Chart-Varianten', text: 'Skalen, Balken und Verlaufsideen zeigen Daten je nach Fragestellung aus verschiedenen Blickwinkeln.', size: 'sm', icon: 'show_chart', annotations: ['Skala', 'Bar', 'Trend'] },
        ],
        liveDemo: { status: 'planned', text: 'Die Live-Demo ist als eigenständiges Angular-Projekt geplant und sollte ausschließlich mit synthetischen Beispielwerten laufen. Echte Gesundheitsdaten gehören nicht in eine öffentliche Portfolio-Demo.' },
      },
      {
      ...
      columns: [
        ...
        },
        {
          title: 'Case Studies', links: [
            ...
            { label: 'Daten Dashboards', href: '/projects/blutanalyse' },
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        titleLines: ['Data', 'Dashboards'],
        kicker: 'PDF analysis, lab values and visual data preparation.',
        summary: 'A dashboard concept that translates lab reports into readable data slices: import values, validate them, optionally edit them by hand and immediately show whether results are within the green range.',
        overviewKicker: 'Visual data presentation.',
        overviewSummary: 'A data-oriented dashboard that turns PDF reports, API imports and manual input into clear cards, reference ranges and charts. The focus is orientation, control and understandable explanations instead of columns of numbers.',
        overviewTechStack: ['Angular', 'TypeScript', 'PDF Analysis', 'API Concept', 'SCSS'],
        description: 'The project treats lab values as a controllable data workflow: reports can be converted into structured records through PDF analysis, API import or manual entry. The dashboard groups values, shows reference ranges, marks findings, explains individual metrics and can include optional context factors such as age, lifestyle or measurement date without deriving a diagnosis from them.',
        goal: 'The goal is a dashboard that gives users more control over hard-to-read reports. Relevant values should be easy to capture, graphically comparable and directly understandable: with green ranges, warning states, trends, detail cards, source hints and a clear separation between technical preparation, explanation and medical assessment.',
        role: 'Concept for data model, PDF/API import, optional manual entry, validation logic, dashboard architecture, chart variants, reference-range UI, context factors, help texts, error states and privacy-friendly demo boundaries.',
        year: '2025',
        type: 'Health Data UI / Document Import',
        accent: 'blue',
        techStack: ['Angular', 'TypeScript', 'Python/API', 'PDF Analysis', 'Serverless Idea', 'SCSS'],
        highlights: ['PDF/API import', 'Manual entry', 'Reference-range scales', 'Dashboard cards', 'Validation', 'Trend view', 'Context factors', 'Accessible data UI'],
        technicalHighlights: [
          { icon: 'upload_file', title: 'Import values', text: 'Reports can be moved into a reviewable preparation flow through PDF analysis, API import or file input.' },
          { icon: 'edit_note', title: 'Manual fallback', text: 'Uncertain or missing values remain editable so users keep control over the captured data.' },
          ...
          { icon: 'monitoring', title: 'Instant classification', text: 'Scales, bars, charts and status cards show faster than tables whether values are inside the green range.' },
          { icon: 'psychology_alt', title: 'On-demand explanations', text: 'Every value can provide understandable hints, context questions and useful next checks.' },
          ...
          { icon: 'person_search', title: 'Context factors', text: 'Age, lifestyle, measurement date or history can be considered as optional visible factors.' },
        ...
        requirements: ['Analyze PDF reports or import them via API', 'Provide manual entry as a fallback', 'Structure lab values reliably', 'Check units and reference ranges', 'Show green ranges and warning states immediately', 'Optionally include context factors', 'Provide help text per value', 'Avoid sensitive data in demos'],
        detailMode: 'data',
        metrics: [
          { value: 'PDF/API', label: 'Import', text: 'Reports start as documents, API data or manual input and become structured records.' },
          { value: '40+', label: 'Value fields', text: 'Lab values need name, unit, reference range, state and explanation.' },
          { value: '3×', label: 'Control', text: 'Extraction, plausibility and manual review prevent blind acceptance.' },
        ...
        bloodShowcase: {
          ...
          lead: 'The core is not a single chart, but a traceable flow: import PDF or API data, validate values, add context, map reference ranges and generate an understandable dashboard.',
          ctaLabel: 'View dashboard flow',
          chips: ['PDF/API Import', 'Value Parser', 'Reference Ranges', 'Help Cards'],
          documentTitle: 'lab_report_2025.pdf',
          documentText: 'Document detected · values are extracted · uncertain fields remain editable.',
          ...
          previewLabel: 'Preview of a data dashboard with PDF import, context values and result charts',
          values: [
          ...
          pipelineSteps: [
            { icon: 'upload_file', title: 'Import', text: 'The user starts with a PDF, API source or manual input. A clean entry point with state, file type, privacy boundary and error handling matters.', points: ['PDF/API input', 'Analysis state', 'Error states'] },
            { icon: 'document_scanner', title: 'Read & capture', text: 'Values are detected, normalized and transferred into editable fields. Uncertain matches must remain visible and correctable.', points: ['Value name', 'Unit', 'Reference range'] },
            { icon: 'rule_settings', title: 'Validate', text: 'Data is checked against expected formats, units, reference ranges and optional context factors before it enters the dashboard.', points: ['Validation', 'Plausibility', 'Context'] },
            { icon: 'analytics', title: 'Visualize', text: 'The UI translates numbers into scales, bars, charts, groups and detail cards so relationships become easier to read.', points: ['Scales', 'Bars', 'Trend idea'] },
          ...
          guideModeLabel: 'Choose value-guide chart style',
          guideModes: [
          ...
          galleryTitle: 'Screens for import, values, explanations and chart variants',
        },
        chapters: [
          { eyebrow: 'Import', title: 'Reports become controllable data', text: 'The technical focus is the transition from PDF, API or manual entry to a reviewable record. Import, recognition, correction and validation need to work as one coherent workflow.', points: ['PDF/API and state', 'Keep detected values editable', 'Mark uncertainty'] },
          { eyebrow: 'Data model', title: 'A blood value is more than name and number', text: 'Every value needs unit, reference range, source, measurement date, state, explanation and optional factors such as age, lifestyle or history. Only then can the UI explain why something stands out.', points: ['Unit and reference range', 'Source and date', 'Context and help text'] },
          { eyebrow: 'Visualization', title: 'Numbers become readable orientation', text: 'The display should not dramatize. Scales, bars, charts, groups and neutral states make it visible whether a value is low, normal, high or worth watching in the example.', points: ['Reference-range scales', 'Compact cards', 'Chart variants'] },
        ...
        gallery: [
          { title: 'Import Flow', text: 'Use PDF, API data or manual input and visibly review uncertain fields.', size: 'md', icon: 'upload_file', annotations: ['PDF', 'API', 'Review'] },
          { title: 'Data Dashboard', text: 'Group lab values, show reference ranges and make findings immediately visible.', size: 'lg', icon: 'monitoring', annotations: ['Hb', 'CRP', 'Ferritin'] },
          ...
          { title: 'Chart Variants', text: 'Scales, bars and trend ideas show data from different angles depending on the question.', size: 'sm', icon: 'show_chart', annotations: ['Scale', 'Bar', 'Trend'] },
        ],
        liveDemo: { status: 'planned', text: 'The live demo is planned as a separate Angular project and should only run with synthetic example values. Real health data does not belong in a public portfolio demo.' },
      },
      {
        slug: 'grafikdesign-katalog',
        name: 'Design Archive',
      ...
      columns: [
        ...
        },
        {
          title: 'Case Studies', links: [
            ...
            { label: 'Data Dashboards', href: '/projects/blutanalyse' },
