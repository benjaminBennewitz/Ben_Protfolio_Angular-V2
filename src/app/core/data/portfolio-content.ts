...
export const PORTFOLIO_TRANSLATIONS: Record<'de' | 'en', PortfolioContent> = {
  de: {
    ...
    experience: {
      ...
      items: [
        { value: '10', suffix: 'Jahre', label: 'Grafikdesign', text: 'Illustrator, Photoshop, InDesign, Lightroom, Editorial Design und Adobe-Skripting – inklusive eines vollständig automatisch generierten, dynamischen Wandkalenders in InDesign und CSV-gestützter Stapelverarbeitung.' },
    ...
    skills: {
      ...
      groups: [
        ...
        { title: 'Design & Content', items: ['Illustrator', 'Photoshop', 'InDesign', 'Adobe Scripting', 'CSV-Automation', 'UI/UX', 'Designsysteme', 'Branding', 'Motion', 'SEO', 'WCAG', 'A11y'] },
      ...
      levels: [
        ...
        { label: 'InDesign / Scripting', value: 55, group: 'Adobe Cloud' },
    ...
    projects: [
      ...
      },
      {
        ...
        gallery: [
          { title: 'Lokale OCR-Pipeline', text: 'PDF-Textschicht, Poppler und Tesseract werden abhängig vom Dokumenttyp zu einem transparenten Importjob kombiniert.', size: 'md', icon: 'document_scanner', annotations: ['PDF', 'Poppler', 'OCR'] },
          { title: 'Neomorphism Dashboard', text: 'Laborwerte, Referenzbereiche und Verläufe werden in einer kontrastreichen, responsiven Oberfläche gruppiert.', size: 'lg', icon: 'monitoring', annotations: ['Groups', 'Ranges', 'Trends'] },
          { title: 'Review & Wissensbasis', text: 'Unsichere Treffer, Quellen, kontrollierte Erklärtexte und Freigabestatus bleiben nachvollziehbar verbunden.', size: 'md', icon: 'fact_check', annotations: ['Confidence', 'Source', 'Release'] },
          { title: 'Patientenbericht', text: 'Freigegebene Daten werden als responsive HTML-Ansicht, Print-Report und lokal übersetzbare Ausgabe aufbereitet.', size: 'sm', icon: 'print', annotations: ['HTML', 'Print', 'Translate'] },
        ],
        liveDemo: { status: 'private', text: 'Globi Flow ist als lokale Demo mit synthetischen Testdaten umgesetzt. Eine öffentliche Instanz ist bewusst eingeschränkt, da das Projekt keine medizinische Anwendung, keine Sicherheitszertifizierung und kein Ersatz für ärztliche Bewertung ist.' },
      },
      {
  ...
  en: {
    ...
    experience: {
      ...
      items: [
        { value: '10', suffix: 'years', label: 'Graphic design', text: 'Illustrator, Photoshop, InDesign, Lightroom, editorial design and Adobe scripting – including a fully automated dynamic wall calendar in InDesign and CSV-driven batch processing.' },
    ...
    skills: {
      ...
      groups: [
        ...
        { title: 'Design & Content', items: ['Illustrator', 'Photoshop', 'InDesign', 'Adobe Scripting', 'CSV Automation', 'UI/UX', 'Design systems', 'Branding', 'Motion', 'SEO', 'WCAG', 'A11y'] },
        { title: 'Shops & Office', items: ['Gambio', 'JTL Wawi', 'WooCommerce', 'Shopify', 'Excel', 'Word', 'PowerPoint', 'VBA'] },
      ],
    ...
    projects: [
      ...
      },
      {
        ...
        liveDemo: { status: 'private', text: 'Globi Flow is implemented as a local demo using synthetic test data. A public instance is intentionally limited because the project is not a medical product, has no security certification and does not replace professional assessment.' },
      },
      {
        slug: 'grafikdesign-katalog',
        name: 'Design Archive',
