...
const LOADER_TRANSLATIONS: Record<'de' | 'en', LoaderTranslation> = {
  de: {
    ...
    dialogs: [
      { percent: 1, title: 'BOOT_B2.EXE', message: 'Gleich soweit. Interface sucht noch den Einschaltknopf.', action: 'OK?', delay: '120ms', left: '7%', top: '15vh', rotate: '-1.6deg', z: 1 },
      { percent: 2, title: 'WOW_SYS.DLL', message: 'Rasterpunkte werden einzeln freundlich begrüßt.', action: '#LOL', delay: '620ms', left: '20%', top: '24vh', rotate: '1.2deg', z: 2 },
      { percent: 10, title: 'HALFTONE.INI', message: 'Schwarzweiß-Grafiken werden dramatisch überzeichnet.', action: 'YES', delay: '1160ms', left: '48%', top: '13vh', rotate: '-0.8deg', z: 3 },
      { percent: 21, title: 'CURSOR.BAT', message: 'Mauszeiger bekommt Haltung und ein bisschen Attitüde.', action: 'MOVE', delay: '1740ms', left: '13%', top: '48vh', rotate: '1.8deg', z: 4 },
      { percent: 35, title: 'CORETEMP.EXE', message: 'Kerntemperatur liegt im idealen Bereich. Kaffee auch.', action: 'NICE', delay: '2380ms', left: '38%', top: '38vh', rotate: '-1.2deg', z: 5 },
      { percent: 52, title: 'CHAOS.SYS', message: 'Kontrolliertes Chaos wird umsortiert.', action: 'F*CK', delay: '3040ms', left: '59%', top: '49vh', rotate: '1.4deg', z: 6 },
      { percent: 68, title: 'DOS_UI.POP', message: 'Dialogfenster streiten kurz um den Vordergrund.', action: 'WIN', delay: '3740ms', left: '26%', top: '62vh', rotate: '-1.9deg', z: 7 },
      { percent: 84, title: 'ACCESS.OK', message: 'Terminalzugang riecht nach Popcorn', action: 'OK', delay: '4480ms', left: '55%', top: '68vh', rotate: '0.9deg', z: 8 },
      { percent: 100, title: 'FINAL_MSG.WTF', message: '', action: 'Sag was Cooles. Sonst bleibt das Interface beleidigt stehen.', delay: '5480ms', left: '34%', top: '26vh', rotate: '0.2deg', z: 9 },
    ],
    logLines: [
  ...
  en: {
    ...
    dialogs: [
      { percent: 1, title: 'BOOT_B2.EXE', message: 'Almost there. Interface is still looking for the power button.', action: 'OK?', delay: '120ms', left: '7%', top: '15vh', rotate: '-1.6deg', z: 1 },
      { percent: 2, title: 'WOW_SYS.DLL', message: 'Halftone dots are being greeted one by one.', action: '#LOL', delay: '620ms', left: '20%', top: '24vh', rotate: '1.2deg', z: 2 },
      { percent: 10, title: 'HALFTONE.INI', message: 'Black-and-white graphics are being dramatically overdrawn.', action: 'YES', delay: '1160ms', left: '48%', top: '13vh', rotate: '-0.8deg', z: 3 },
      { percent: 21, title: 'CURSOR.BAT', message: 'Cursor gets posture and a bit of attitude.', action: 'MOVE', delay: '1740ms', left: '13%', top: '48vh', rotate: '1.8deg', z: 4 },
      { percent: 35, title: 'CORETEMP.EXE', message: 'Core temperature looks ideal. Coffee too.', action: 'NICE', delay: '2380ms', left: '38%', top: '38vh', rotate: '-1.2deg', z: 5 },
      { percent: 52, title: 'CHAOS.SYS', message: 'Controlled chaos is being sorted again.', action: 'F*CK', delay: '3040ms', left: '59%', top: '49vh', rotate: '1.4deg', z: 6 },
      { percent: 68, title: 'DOS_UI.POP', message: 'Dialog windows briefly argue about z-index.', action: 'WIN', delay: '3740ms', left: '26%', top: '62vh', rotate: '-1.9deg', z: 7 },
      { percent: 84, title: 'ACCESS.OK', message: 'Terminal access smells like popcorn.', action: 'OK', delay: '4480ms', left: '55%', top: '68vh', rotate: '0.9deg', z: 8 },
      { percent: 100, title: 'FINAL_MSG.WTF', message: '', action: 'Say something cool or the interface stays offended.', delay: '5480ms', left: '34%', top: '26vh', rotate: '0.2deg', z: 9 },
    ],
    logLines: [
      '[sys] ms-dos collage layer mounted',
      '[ux] reveal masks armed',
