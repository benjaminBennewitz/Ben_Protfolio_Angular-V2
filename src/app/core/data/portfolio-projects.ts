      ...
      },
      {
        ...
        boardShowcase: {
          ...
          mascot: {
            ...
            previewImage: 'assets/images/projects/carly-managed/storybook/carly-story-04.webp',
            previewAlt: 'Storyboard-Illustration von Carly auf einem Turm über einer märchenhaften Landschaft',
            previewCaption: 'Aus der internen Lore: Carly trägt ihre magische Herkunft sichtbar in die Produktwelt.',
            principles: [
            ...
            storyBeats: [
              ...
              { label: 'Kapitel 03', title: 'Companion im Produkt', text: 'Innerhalb von Carly Managed wird sie zur UX-Ebene für Fortschritt, Fokus und Meilensteine – eingebettet in Score, Trophäen und Statusfeedback.' },
            ...
            facts: [
              ...
              { value: 'Score', label: 'Feedback', text: 'Scoring, Reaktionen und Trophäen visualisieren Fortschritt im passenden Moment direkt im Arbeitsfluss.' },
        ...
        gallery: [
          { title: 'Dashboard', text: 'Eigene Aufgaben, Widgets, Aktivität und Arbeitsstart in einer verdichteten Übersicht.', image: 'assets/images/projects/carly-managed/screens/dashboard.webp', backgroundColor: '#f7f3fb', alt: 'Carly Managed Dashboard mit Aufgabenübersicht, Aktivitätsbereich und Teamwidgets', size: 'lg', annotations: ['My Tasks', 'Widgets', 'Live'], detail: 'Das Dashboard bündelt persönliche Arbeit, Teamaktivität und Einstiege in weitere Bereiche. Ziel ist ein schneller produktiver Start, ohne zwischen mehreren Views springen zu müssen.', tools: ['Angular', 'Dashboard', 'Realtime'], year: '2026' },
          { title: 'Kanban Board', text: 'Spalten, Karten, Swimlanes und klare Priorisierung direkt im Projektfluss.', image: 'assets/images/projects/carly-managed/screens/board.webp', backgroundColor: '#f4f2fb', alt: 'Carly Managed Kanban Board mit Statusspalten und Aufgabenkarten', size: 'lg', annotations: ['Backlog', 'Doing', 'Review'], detail: 'Das Board bildet den Kern des Projektflusses: Status, Verantwortlichkeit, Priorität und Kommentaranzahl bleiben direkt auf der Karte sichtbar.', tools: ['Kanban', 'Drag & Drop', 'Task Workflow'], year: '2026' },
          ...
          { title: 'Inbox', text: 'Persönliche Eingänge und neue Zuweisungen bleiben als fokussierter Arbeitsstartpunkt sichtbar.', image: 'assets/images/projects/carly-managed/screens/inbox.webp', backgroundColor: '#f7f3fb', alt: 'Carly Managed Inbox mit neuen Aufgaben und Nachrichten', size: 'md', annotations: ['Inbox', 'Assignments', 'Updates'], detail: 'Die Inbox reduziert Streuverlust: neue Aufgaben, Rückmeldungen und relevante Änderungen landen gesammelt in einer klaren Arbeitsliste.', tools: ['Notifications', 'Task Intake', 'Realtime'], year: '2026' },
          ...
          { title: 'Carly Panel', text: 'Die Mascot-Ebene verbindet Story, Motivation und freundliche Statushinweise direkt mit dem Produkt.', image: 'assets/images/projects/carly-managed/screens/carly.webp', backgroundColor: '#fbf6ff', alt: 'Carly Managed Ansicht mit Carly-Maskottchen und motivierendem Feedback', size: 'md', annotations: ['Mascot', 'Mood', 'Magic'], detail: 'Carly ist als Companion bewusst in die UI eingebettet und soll Fortschritt, Belohnungen und emotionale Resonanz in einer kontrollierten Form sichtbar machen.', tools: ['Mascot UX', 'Gamification', 'Feedback'], year: '2026' },
          { title: 'Einstellungen', text: 'Nutzerbezogene Steuerung und Systemkonfiguration bleiben klar vom Projektworkflow getrennt.', image: 'assets/images/projects/carly-managed/screens/settings.webp', backgroundColor: '#f6f3fb', alt: 'Carly Managed Einstellungen mit Profil- und Konfigurationsbereichen', size: 'md', annotations: ['Settings', 'Config', 'Profile'], detail: 'Einstellungen und Präferenzen folgen einer eigenen Struktur, damit operative Projektarbeit nicht mit Verwaltungsaufgaben vermischt wird.', tools: ['Settings', 'Profile', 'Configuration'], year: '2026' },
        ],
      ...
      },
      {
        ...
        boardShowcase: {
          ...
          mascot: {
            ...
            previewImage: 'assets/images/projects/carly-managed/storybook/carly-story-04.webp',
            previewAlt: 'Story illustration of Carly on a tower above a fairytale landscape',
            previewCaption: 'From the internal lore: Carly carries her magical origin directly into the product world.',
            principles: [
            ...
            storyBeats: [
              ...
              { label: 'Chapter 03', title: 'Companion inside the product', text: 'Inside Carly Managed she becomes a UX layer for progress, focus and milestones, embedded in score, trophies and feedback states.' },
            ...
            facts: [
              ...
              { value: 'Score', label: 'Feedback', text: 'Scoring, reactions and trophies visualize progress at the right moment directly in the workflow.' },
        ...
        gallery: [
          { title: 'Dashboard', text: 'Personal tasks, widgets, activity and a dense working entry point in one overview.', image: 'assets/images/projects/carly-managed/screens/dashboard.webp', backgroundColor: '#f7f3fb', alt: 'Carly Managed dashboard with task overview, activity stream and team widgets', size: 'lg', annotations: ['My Tasks', 'Widgets', 'Live'], detail: 'The dashboard combines personal work, team activity and entry points into further areas. The goal is a productive start without forcing users through multiple views.', tools: ['Angular', 'Dashboard', 'Realtime'], year: '2026' },
          { title: 'Kanban Board', text: 'Columns, cards, swimlanes and clear prioritization directly inside the project flow.', image: 'assets/images/projects/carly-managed/screens/board.webp', backgroundColor: '#f4f2fb', alt: 'Carly Managed Kanban board with status columns and task cards', size: 'lg', annotations: ['Backlog', 'Doing', 'Review'], detail: 'The board forms the core project flow: status, ownership, priority and comment count remain visible directly on the card.', tools: ['Kanban', 'Drag & Drop', 'Task Workflow'], year: '2026' },
          { title: 'Members', text: 'Team management with roles, ownership and project-related context.', image: 'assets/images/projects/carly-managed/screens/members.webp', backgroundColor: '#f6f3fb', alt: 'Carly Managed members view with team cards and role information', size: 'md', annotations: ['Members', 'Roles', 'Projects'], detail: 'The members view makes roles, ownership and team structure visible and supports responsibility across multiple projects.', tools: ['Team UI', 'Permissions', 'Member Management'], year: '2026' },
          { title: 'Inbox', text: 'Personal incoming work and new assignments stay visible as a focused starting point.', image: 'assets/images/projects/carly-managed/screens/inbox.webp', backgroundColor: '#f7f3fb', alt: 'Carly Managed inbox with new tasks and messages', size: 'md', annotations: ['Inbox', 'Assignments', 'Updates'], detail: 'The inbox reduces scatter: new tasks, responses and relevant changes arrive in one clear worklist.', tools: ['Notifications', 'Task Intake', 'Realtime'], year: '2026' },
          { title: 'Pool', text: 'Unassigned or shared tasks can be reviewed centrally and claimed by the team.', image: 'assets/images/projects/carly-managed/screens/pool.webp', backgroundColor: '#f7f2fa', alt: 'Carly Managed pool view with shared open tasks', size: 'md', annotations: ['Pool', 'Shared', 'Open'], detail: 'The pool represents a shared work reserve and makes open or not-yet-assigned tasks visible to the team.', tools: ['Shared Work', 'Assignment', 'Task Pool'], year: '2026' },
          { title: 'Archive', text: 'Completed or inactive work stays searchable without overloading the active surface.', image: 'assets/images/projects/carly-managed/screens/archive.webp', backgroundColor: '#f5f2fa', alt: 'Carly Managed archive view with completed items', size: 'sm', annotations: ['Archive', 'History', 'Closed'], detail: 'The archive removes finished or inactive items from day-to-day work while keeping them available for traceability and research.', tools: ['History', 'Archive', 'Clean UI'], year: '2026' },
          { title: 'Projects', text: 'Project overviews condense state, task volume and entry points into separate workspaces.', image: 'assets/images/projects/carly-managed/screens/projects.webp', backgroundColor: '#f7f4fb', alt: 'Carly Managed project overview with project cards and status values', size: 'md', annotations: ['Projects', 'Status', 'Overview'], detail: 'The project overview creates orientation across multiple workspaces and connects dashboard-level orientation with the individual workspace.', tools: ['Project Overview', 'Status Cards', 'Navigation'], year: '2026' },
          { title: 'Carly Panel', text: 'The mascot layer connects story, motivation and friendly state hints directly to the product.', image: 'assets/images/projects/carly-managed/screens/carly.webp', backgroundColor: '#fbf6ff', alt: 'Carly Managed view with Carly mascot and motivational feedback', size: 'md', annotations: ['Mascot', 'Mood', 'Magic'], detail: 'Carly is intentionally embedded as a companion and is meant to surface progress, rewards and emotional resonance in a controlled form.', tools: ['Mascot UX', 'Gamification', 'Feedback'], year: '2026' },
          { title: 'Settings', text: 'User preferences and system configuration remain clearly separated from project work.', image: 'assets/images/projects/carly-managed/screens/settings.webp', backgroundColor: '#f6f3fb', alt: 'Carly Managed settings with profile and configuration sections', size: 'md', annotations: ['Settings', 'Config', 'Profile'], detail: 'Settings and preferences follow their own structure so project work does not get mixed with administration.', tools: ['Settings', 'Profile', 'Configuration'], year: '2026' },
        ],
