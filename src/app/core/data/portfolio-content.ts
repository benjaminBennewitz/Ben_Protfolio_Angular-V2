  ...
  de: {
    ...
    projects: [
      ...
      },
      {
        ...
        overviewKicker: 'Interaktive Umwelt-Simulation mit verzögerten Ursache-Wirkungs-Ketten.',
        overviewSummary: 'Drei Ökosysteme reagieren auf Nutzerentscheidungen. PixiJS, Canvas und ein Web Worker verbinden 2.5D-Visualisierung, Simulation und performante Zustandsberechnung vollständig im Browser.',
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        overviewKicker: 'Interactive environmental simulation with delayed cause-and-effect chains.',
        overviewSummary: 'Three ecosystems react to user decisions. PixiJS, Canvas and a Web Worker connect 2.5D visualization, simulation and performant state calculation entirely in the browser.',
        overviewTechStack: ['Angular', 'TypeScript', 'PixiJS', 'Web Worker', 'SCSS'],
